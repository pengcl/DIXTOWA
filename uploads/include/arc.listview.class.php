...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class='prev disabled' href='javascript:;'><i
                                                       class='icons icons-back'></i></a><a href='javascript:;' class='curr'>1</a><a class='next disabled' href='javascript:;'><i
                                                                                                                                    class='icons icons-right'></i></a>";
        }
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class='prev' href='".str_replace("{page}",$prepagenum,$tnamerule)."'><i
                                   class='icons icons-back'></i></a>";
            $indexpage="";
        }
        else
        {
            $prepage.="<a class='prev disabled' href='".str_replace("{page}",$prepagenum,$tnamerule)."'><i
                                           class='icons icons-back'></i></a>";
            $indexpage="";
        }
        ...
        {
            $nextpage.="<a class='next' href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><i
                                    class='icons icons-right'></i></a>";
            $endpage="";
        }
        else
        {
        $nextpage.="<a class='next disabled' href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><i
                                            class='icons icons-right'></i></a>";
            $endpage="";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<a href='".str_replace("{page}",$j,$tnamerule)."' class='curr'>".$j."</a>";
            }
            else
            {
                $listdd.="<a href='".str_replace("{page}",$j,$tnamerule)."' class=''>".$j."</a>";
            }
        }
        $plist = '';
